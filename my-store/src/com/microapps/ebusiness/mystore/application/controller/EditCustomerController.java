...
public class EditCustomerController extends BaseController implements Initializable, Routeable{
	...
	private void loadCustomerAndSetValues() {
		 c = Session.getSession().getCustomerFromSession();
	...
	public void showView(Stage stage) {
		FXMLLoader fxmlLoader = new FXMLLoader(EditCustomerController.class.getResource(ViewTemplateConstants.CUSTOMER_EDIT_VIEW));
        try {
